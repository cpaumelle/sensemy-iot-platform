...
async def root():
    return {
        ...
        "endpoints": [
            ...
            "/v1/environment/metrics/temperature",
            "/v1/environment/metrics/humidity",
            "/v1/environment/metrics/co2",
            "/v1/environment/sensors/capabilities",
            "/v1/environment/metrics/compare"
        ],
        "features": {
